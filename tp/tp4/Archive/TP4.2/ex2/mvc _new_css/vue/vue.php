...
function displayCustomer($listingCustomer) {
	...
	foreach ($listingCustomer as $line ) {
		...
		$displayContents.='<p class="displayContentsp"><input type="checkbox" name="'.$line->id.'">Client n° '.$line->id.' : '.'<input type="text" name="nameCustomer" readonly="readonly" value="'.$sentence.'"/></p>';
	}
