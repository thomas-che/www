...
$jour=date('w'); // Jour de la semaine au format numérique ex: 0 (pour dimanche) à 6 (pour samedi)
...
echo '<div id="titreMois" align="center">
        <a href="semaine.php?week=pre&jour='.$jour.'"><<</a> Semaine '.$num_week.' <a href="semaine.php?week=next&jour='.$jour.'">>></a><br />
